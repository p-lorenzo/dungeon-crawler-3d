...
#
# Adapted from fstandhartinger/ralph-wiggum for OpenCode CLI.
#
# Key principles:
...
How it works:
  1. Each iteration feeds a minimal prompt to opencode via stdin
  2. opencode reads the constitution to find the highest priority incomplete spec/task
...
if ! command -v "$OPENCODE_CMD" &> /dev/null; then
    ...
    echo ""
    echo "Install OpenCode first: npm install -g @opencode-ai/cli"
    echo "Or set OPENCODE_CMD environment variable to the path of the opencode binary."
    exit 1
fi
...
# Ralph Loop — Build Mode (OpenCode)

You are running inside a Ralph Wiggum autonomous loop powered by OpenCode.
...
# Ralph Loop — Planning Mode (OpenCode)
...
echo ""
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo -e "${GREEN}              RALPH LOOP (OpenCode) STARTING                  ${NC}"
echo -e "${GREEN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${NC}"
echo ""
...
while true; do
    ...
    # Run opencode with prompt via stdin, capture output
    OPENCODE_OUTPUT=""
    if OPENCODE_OUTPUT=$(cat "$PROMPT_FILE" | "$OPENCODE_CMD" run 2>&1 | tee "$LOG_FILE"); then
        if [ -n "$WATCH_PID" ]; then
